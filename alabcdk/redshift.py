...
class RedshiftBase(Construct):
    def __init__(
        ...
        **kwargs,
        ...
        # Redshift IAM Role
        principals = aws_iam.CompositePrincipal(
        ...
        self.security_group = self.define_security_group(
            ingress_peers_sg=([self.client_group] + client_security_groups),
    ...
    def define_security_group(
        self,
        *,
        ingress_peers_sg: List[aws_ec2.ISecurityGroup] = [],
        ingress_peers_ipv4: List[str] = [],
    ...
    def __init__(
        ...
        **kwargs,
        ...
        master_password = (
            ...
            else SecretValue.unsafe_plain_text(admin_password)
        )
        type_of_cluster = (
